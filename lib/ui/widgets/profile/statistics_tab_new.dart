...
class _StatisticsTabState extends State<StatisticsTab> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      switch (_selectedMetric) {
        case 'calories':
          final caloriesData = await statisticsVM.getCaloriesData(user.uid, _selectedPeriod);
          _chartData = caloriesData;
          break;
        case 'exercises':
          final exercisesData = await statisticsVM.getExercisesData(user.uid, _selectedPeriod);
          _chartData = exercisesData;
          break;
        case 'active_days':
          final activeDaysData = await statisticsVM.getActiveDaysData(user.uid, _selectedPeriod);
          _chartData = activeDaysData;
          break;
      }
  ...
  Widget _getBottomTitleWidget(int value) {
    ...
    if (_selectedPeriod == 'week' && value < days.length) {
      return Text(
        days[value],
        style: const TextStyle(
          color: Colors.grey,
